...
<div class="row">
    <div align="left">
        <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#addEmployeeModal">Add Employee</button>
    </div>
    <div class="container">
...
<!-- Add Branch Modal -->
<div class="modal fade" id="addBranchModal" tabindex="-1" role="dialog" aria-labelledby="addEmployeeModal" aria-hidden="true">
